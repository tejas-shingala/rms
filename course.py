...
class courseclass:
    def __init__(self, root):
        ...
        title = Label(self.root, text="manage course details",padx=10,compound=LEFT, font=("goudy old style", 20, "bold"), bg="#033054", fg="white").place(x=10,y=15,width=1180,height=35)
        ...
        btn_search_coursename = Button(self.root, text="search", font=("goudy old style", 15,'bold'), bg='#03a9f4', fg='white', cursor="hand2",command=self.search).place(x=1070,y=60, width=120, height=28)
    ...
    def delete(self):
        ...
        try:
            if self.var_course.get() == "" :
                messagebox.showerror("Error", "Course Name should not be empty",parent=self.root)
            else:
